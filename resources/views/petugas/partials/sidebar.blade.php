    ...
    <div class="flex-1 px-4 py-4 overflow-y-auto">
        ...
        <nav class="space-y-2">
            ...
            <a href="{{ route('petugas.alasan-penolakan.index') }}" 
               class="sidebar-transition flex items-center gap-4 px-4 py-3.5 rounded-2xl font-bold text-sm {{ request()->is('petugas/alasan-penolakan*') ? 'nav-item-active-petugas shadow-sm' : 'text-gray-500 hover:text-indigo-600' }}">
