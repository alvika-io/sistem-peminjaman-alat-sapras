...
<nav class="bg-white/90 backdrop-blur-md border-b border-gray-100 sticky top-0 z-40 w-full px-8 py-5">
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-5">
            <div class="lg:hidden bg-indigo-600 p-2.5 rounded-2xl shadow-lg shadow-indigo-100 cursor-pointer active:scale-90 transition-all">
            ...
            <div class="hidden sm:block text-left">
                <p class="text-[10px] font-black text-indigo-600 uppercase tracking-[0.3em] leading-none mb-1">Staff Operations</p>
                <h1 class="text-lg font-black text-gray-800 tracking-tighter">Panel Petugas <span class="text-indigo-600">SIPRAS</span></h1>
            </div>
        </div>
        ...
        <div class="flex items-center gap-2">
            ...
            <div class="hidden md:flex flex-col items-end px-6 border-r border-gray-100 transition-all">
                ...
                <div class="flex items-center gap-1.5 mt-0.5">
                    ...
                    <span class="text-[10px] font-extrabold text-indigo-600 uppercase tracking-widest bg-indigo-50 px-2 py-0.5 rounded-md">
                        {{ auth()->user()->role }}
                    </span>
                </div>
            </div>
