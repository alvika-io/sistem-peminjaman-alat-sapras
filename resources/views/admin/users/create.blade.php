...
<head>
    ...
    <title>Tambah User - SIPRAS</title>
...
<div class="main-wrapper">
    ...
    <div class="content-area">
        ...
        <main class="p-8 lg:p-12 flex flex-col items-center">
            ...
            <div class="w-full max-w-2xl mb-10 text-center lg:text-left">
                <div class="flex items-center gap-3 mb-2 justify-center lg:justify-start">
                    <span class="h-1 w-8 bg-blue-600 rounded-full"></span>
                    <span class="text-[10px] font-black text-blue-600 uppercase tracking-[0.3em]">Registrasi Internal</span>
                </div>
                <h1 class="text-4xl font-black text-gray-900 tracking-tighter">Tambah User</h1>
                <p class="text-gray-500 font-medium mt-1">Daftarkan personil baru ke dalam sistem SIPRAS.</p>
            </div>
            ...
            <div class="w-full max-w-2xl bg-white rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.03)] border border-gray-100 overflow-hidden mb-12">
                <div class="p-8 lg:p-12">
                    <form method="POST" 
                          ...
                          data-message="Yakin ingin menambahkan user ini?">
                        @csrf
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" required 
                                    class="form-input-custom w-full pl-11 pr-4 py-4 bg-gray-50 border border-gray-100 rounded-2xl outline-none focus:border-blue-500 focus:bg-white transition-all font-bold text-gray-800 placeholder:text-gray-300 placeholder:font-medium"
                                    placeholder="contoh@sipras.com">
                            </div>
                        </div>

                        <div class="space-y-2">
                            <label class="text-sm font-black text-gray-700 ml-1 uppercase tracking-widest text-[10px]">Kata Sandi</label>
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 flex items-center pl-4 text-gray-400">
                        ...
                        <div class="pt-6 flex flex-col sm:flex-row gap-4">
                            ...
                            <a href="{{ route('admin.users.index') }}" 
                               class="flex-1 py-4 bg-white hover:bg-gray-50 text-gray-500 font-bold rounded-2xl text-center transition-all uppercase tracking-widest text-xs border border-gray-100">
                                Batal
                            </a>
                        </div>
                    </form>
            ...
            <p class="text-center text-gray-300 text-[10px] mt-4 font-bold uppercase tracking-widest">
                SIPRAS Security Protocol &copy; 2026
            </p>
        </main>
    </div>
</div>
