    ...
    <div class="content-area flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <div class="content flex-1 overflow-y-auto p-8 lg:p-12">
            ...
            <div class="mb-10">
                ...
                <p class="text-gray-500 font-medium mt-1">Sistem Pemantauan Sarana & Prasarana Digital.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
                ...
                <div class="dashboard-card bg-white p-6 rounded-[2.5rem] border border-gray-100 shadow-sm flex flex-col gap-4">
                    ...
                    <div>
                        <p class="text-[11px] font-black text-gray-400 uppercase tracking-widest mb-1">Jumlah Alat</p>
                        <h2 class="text-3xl font-black text-gray-900 tracking-tighter">
                            {{ number_format($totalAlat) }}
                            <span class="text-xs text-gray-300 font-medium italic uppercase tracking-widest ml-1">Unit</span>
                        </h2>
                    </div>
                </div>
                ...
                <div class="dashboard-card bg-white p-6 rounded-[2.5rem] border border-gray-100 shadow-sm flex flex-col gap-4">
                    ...
                    <div>
                        <p class="text-[11px] font-black text-gray-400 uppercase tracking-widest mb-1">Stok Tersedia</p>
                        <h2 class="text-3xl font-black text-gray-900 tracking-tighter">
                            {{ number_format($totalAlat - $alatDipinjam) }}
                            <span class="text-xs text-gray-300 font-medium italic uppercase tracking-widest ml-1">Unit</span>
                        </h2>
                    </div>
                </div>
                ...
                <div class="dashboard-card bg-white p-6 rounded-[2.5rem] border border-gray-100 shadow-sm flex flex-col gap-4">
                    ...
                    <div>
                        <p class="text-[11px] font-black text-gray-400 uppercase tracking-widest mb-1">Sedang Dipinjam</p>
                        <h2 class="text-3xl font-black text-gray-900 tracking-tighter">
                            {{ number_format($alatDipinjam) }}
                            <span class="text-xs text-gray-300 font-medium italic uppercase tracking-widest ml-1">Unit</span>
                        </h2>
                    </div>
                </div>
                ...
                <div class="dashboard-card bg-white p-6 rounded-[2.5rem] border border-gray-100 shadow-sm flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <h2 class="text-3xl font-black text-gray-900 tracking-tighter">
                            {{ number_format($peminjamAktif) }}
                            <span class="text-xs text-gray-300 font-medium italic uppercase tracking-widest ml-1">User</span>
                        </h2>
                    </div>
                </div>
                ...
                <div class="dashboard-card bg-white p-6 rounded-[2.5rem] border border-gray-100 shadow-sm flex flex-col gap-4">
                    ...
                    <div>
                        <p class="text-[11px] font-black text-gray-400 uppercase tracking-widest mb-1">Total Petugas</p>
                        <h2 class="text-3xl font-black text-gray-900 tracking-tighter">
                            {{ number_format($totalPetugas) }}
                            <span class="text-xs text-gray-300 font-medium italic uppercase tracking-widest ml-1">Staff</span>
                        </h2>
                    </div>
                </div>
            ...
            <div class="mt-12 pt-8 border-t border-gray-100">
                <p class="text-center text-gray-300 text-[10px] font-bold uppercase tracking-widest">
