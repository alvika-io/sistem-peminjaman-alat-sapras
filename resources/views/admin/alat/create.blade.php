                            ...
                            <div class="space-y-6">
                                <div class="space-y-2">
                                    ...
                                    <div class="relative group">
                                        <div class="w-full h-64 bg-gray-50 border-2 border-dashed border-gray-200 rounded-[2rem] flex flex-col items-center justify-center p-6 transition-all group-hover:border-blue-300 group-hover:bg-blue-50/30">
